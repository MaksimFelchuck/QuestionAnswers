...
### Авторизация:
- **Вопросы**: публичный доступ на чтение, создание без авторизации
- **Ответы**: создание/редактирование/удаление только авторизованными пользователями
- **Пользователи**: только автор может редактировать/удалять свои ответы
...
- ✅ Только автор может редактировать/удалять свои ответы
...
| PUT | `/{question_id}` | Обновить вопрос | ❌ |
...
| PUT | `/{answer_id}` | Обновить ответ (только автор) | ✅ |
...
### Покрытие тестами:
- **84 теста** покрывают все основные функции
